...
$get=$conn->query("SELECT * FROM `scholar` left join `program` on program.program_id = scholar.program_id where scholar.status = 'P'") or die(mysqli_error());
...
$file_name = "TESDA_Exported_Data_{$current_month_year}.pdf";
