          ...
          <div class="announcement">
            <div class="announcement-container">
              ...
              <div class="announcement-container-info">
                <input name="announceTitle" class="input" type="text" placeholder="Title">
                <textarea name="announceMessage" height="300px" width="100%" placeholder="Description" class="description"></textarea>
